export default function Terms() {
  return (
    <div>
      <p>
  Welcome to Personal Log (referred to as THE WEBSITE) Personal Log was created by Dagny Mol.
</p><p>
...
The Website and included content (and any derivative works or enhancements of the same) including, but not limited to, all text, illustrations, files, images, software, scripts, graphics, photos, sounds, music, videos, information, content, materials, products, services, URLs, technology, documentation, and interactive features (collectively, the Website Content) and all intellectual property rights to the same are owned by Dagny Mol, our licensors, or both. The website code is licensed under the MIT License as documented at https://github.com/dagnymol81/personal-log/blob/main/LICENSE.md
</p><p>
 User submitted content remains property of the user. By using this website you grant us the right to save and reproduce this content for the purpose of providing the service, as outlined by the terms in the privacy policy. Additionally, all trademarks, service marks, trade names and trade dress that may appear on the Website are owned by us, our licensors, or both. Except for the limited use rights granted to you in these Terms of Use, you shall not acquire any right, title or interest in the Website or any Website Content. Any rights not expressly granted in these Terms of Use are expressly reserved. 
</p><p>
II.	WEBSITE ACCESS AND USE      
</p><p>                                                                               
	A.	Access to the Website including, without limitation, the Website Content is 	provided for your information and personal  use only. When using the Website, you agree to comply with all applicable federal, state, and local laws including copyright law. Except as expressly permitted in these Terms of Use, you may not use, reproduce, distribute, create derivative works based upon, publicly display, publicly perform, publish, transmit, or otherwise exploit Website Content for any purpose whatsoever without obtaining prior written consent from us or, in the case of third-party content, its respective owner. 
</p><p>  
...
<br />	
	8.	Encourage conduct that violates any local, state or federal law, either civil or criminal, or impersonate another user, person, or entity (e.g., using another person's Membership without permission, etc.); 
<br />	
...
<br />
11.	You agree to cooperate fully with Dagny Mol to investigate any suspected or actual activity that is in breach of these Terms of Use. 
</p><p>
...
A.	In order to access or use some features of the Website, you will have to 	become a registered user. If you are under the age of thirteen, then you are not permitted to register as a user or otherwise submit personal information to this Website.
<br />	
B.	If you become a registered user, you will provide true, accurate and complete registration information and, if such information changes, you will promptly update the relevant registration information. During registration, you will create a username and password (a Membership), which may permit you access to certain areas of the Website not available to non-registered users. You are responsible for safeguarding and maintaining the confidentiality of your Membership. You are solely responsible for the activity that occurs under your Membership, whether or not you have authorized the activity. You agree to notify us immediately at codebymol@gmail.com of any breach of security or unauthorized use of your Membership. 
</p><p>
...
V.	USER CONTENT
  ...
  <br />
	...
	D.	By submitting User Content to us, simultaneously with such posting you 	automatically grant, or warrant that the owner has expressly granted, to us a worldwide, 	royalty-free, perpetual, irrevocable, non-exclusive, fully licensable, and transferable right 	and license to use, record, reproduce, distribute, create derivative works based upon (including, without limitation, translations), publicly display, publicly perform, transmit, publish and otherwise exploit the User Content (in whole or in part) as necessary to provide Website Services (1) in connection with our business; and (2) in connection with the businesses of our successors, parents, subsidiaries, and their related companies. We may exercise this grant in any format, media or technology now known or later developed for the full term of any copyright that may exist in such User Content. The granted rights include the 	right to configure, host, index, cache, digitize, compress, optimize, modify, edit, adapt, and remove such content and combine same with other materials. Furthermore, we are free to use any ideas, concepts, know-how or techniques contained in any User Content you submit without any remuneration or obligation to you. 
</p><p> 
...
H.	The rights granted by you hereunder may not be terminated, revoked or rescinded and are not subject to reversion. If you become aware that User Content you have submitted includes any material for which you lack the unrestricted right to grant us the rights set forth above without obligations or liability to any party, you agree to promptly provide us with detailed written notice thereof to Dagny Mol, codebymol@gmail.com
</p><p> 
VI.	WEBSITE CONTENT & THIRD PARTY LINKS 
</p><p> 
...
A.	UNDER NO CIRCUMSTANCES SHALL DAGNY MOL, AND ITS 	EMPLOYEES, AGENTS, DISTRIBUTION PARTNERS, AFFILIATES, SUBSIDIARIES AND THEIR RELATED COMPANIES BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES ARISING OUT OF, RELATING TO, OR IN ANY WAY CONNECTED WITH THE WEBSITE OR THESE TERMS OF USE. YOUR SOLE REMEDY FOR DISSATISFACTION WITH THE WEBSITE INCLUDING, WITHOUT LIMITATION, THE WEBSITE CONTENT IS TO 	STOP USING THE WEBSITE. SUCH LIMITATION SHALL ALSO APPLY WITH RESPECT TO DAMAGES INCURRED BY REASON OF SERVICES OR PRODUCTS 	RECEIVED THROUGH OR ADVERTISED IN CONNECTION WITH ANY OF THE 	WEBSITE OR ANY LINKS ON THE WEBSITE, AS WELL AS BY REASON OF ANY INFORMATION OR ADVICE RECEIVED THROUGH OR ADVERTISED IN 	CONNECTION WITH ANY OF THE WEBSITE OR ANY LINKS ON THE WEBSITE. 	SUCH LIMITATION SHALL ALSO APPLY WITH RESPECT TO DAMAGES INCURRED BY REASON OF ANY CONTENT POSTED BY A THIRD-PARTY OR CONDUCT OF A THIRD-PARTY ON THE WEBSITE. 
  ...
  A.	We reserve the right in our sole discretion and at any time to terminate or suspend your Membership and/or block your access to the Website for any reason including, without limitation if you have failed to comply with the letter and spirit of these Terms of Use. You agree that Dagny Mol, shall not be liable to you or any third party for any termination or suspension of your Membership or for blocking your access to the Website. 
</p><p> 
  B.	If you become a registered user, you may terminate your Membership at any time by sending an e-mail to codebymol@gmail.com
</p><p> 
  C.	Any suspension or termination shall not affect your obligations to us under 	these Terms of Use. The provisions of these Terms of Use which by their nature 	should 	survive the suspension or termination of your Membership or these Terms of Use shall 	survive including, but not limited to the rights and licenses that you have granted 	hereunder, indemnities, releases, disclaimers, limitations on liability, and provisions 	related to choice of law, 
</p><p> 
  XI.	CHOICE OF LAW
</p><p>                                                                                                        
   These Terms of Use shall be construed in accordance with the laws of the State of Pennsylvania without regard to its conflict of laws rules. 
</p><p> 
